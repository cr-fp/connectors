...
def test_base_state_manager_accepts_valid_input(dummy_connector_state_manager):
...
def test_base_state_manager_rejects_invalid_input(dummy_connector_state_manager):
...
def test_base_state_manager_save(
    ...
    # Then: `OpenCTIConnectorHelper.set_state` method should be called with the correct dict
