...
Legacy `import_document_ai.*` config keys and `IMPORT_DOCUMENT_AI_*` environment variables are still accepted for backward compatibility, but the names above are the preferred ones.
